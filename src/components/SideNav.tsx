...
interface NavItemProps {
    to: string; // Use 'to' prop for NavLink
...
const BottomNav: React.FC = () => { // No longer needs currentPage or setCurrentPage props
    return (
